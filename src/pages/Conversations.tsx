    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden" style={{ height: 'calc(100vh - 180px)', minHeight: 480 }}>
        <div className="flex h-full">
          {/* ── Left panel: list ── */}
          <div className="w-full sm:w-72 md:w-80 flex-shrink-0 border-r border-slate-200 flex flex-col" style={{ display: activeOffer ? undefined : 'flex' }}>
            {/* Tabs */}
            ...
            {/* Stats bar */}
            <div className="border-t border-slate-200 bg-slate-50 px-4 py-2.5 flex justify-around flex-shrink-0">
              {[
